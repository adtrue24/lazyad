...
(function() {
  var supports = (function() {
    ...
    var html;
    var work = this.document.createElement(ad_element);
  ...
  function htmlParser(stream, options) {
    ...
    var el = document.createElement(ad_element);
...
;LazyAds = (function() {
    ...
    var config = {
        containerElement: ad_element,
        containerClass: ad_class
    };
    var startTime;
    ...
    function processAll(adContainers) {
        ...
        for (var x = 0; x < adContainers.length; x++) {
            ...
            {
              mq  = ad_rs['data_matchmedia'];
              //lazyAdEl.innerHTML = ad_rs['data_src'];
            }
            else
            {
